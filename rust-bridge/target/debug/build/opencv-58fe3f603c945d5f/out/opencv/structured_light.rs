pub mod structured_light {
	...
	//! of the codewords are multiplexed in time [pattern](https://docs.opencv.org/4.11.0/d0/de3/citelist.html#CITEREF_pattern) .
	//! 
	//! In this module a time-multiplexing coding strategy based on Gray encoding is implemented following the
	//! (stereo) approach described in 3DUNDERWORLD algorithm [UNDERWORLD](https://docs.opencv.org/4.11.0/d0/de3/citelist.html#CITEREF_UNDERWORLD) .
