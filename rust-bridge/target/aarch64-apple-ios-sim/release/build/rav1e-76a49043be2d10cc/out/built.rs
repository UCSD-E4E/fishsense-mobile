...
#[allow(dead_code)]
pub static TARGET: &str = "aarch64-apple-ios-sim";
...
#[allow(dead_code)]
pub static RUSTC: &str = "/Users/brendonalexander/.rustup/toolchains/1.86-aarch64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/Users/brendonalexander/.rustup/toolchains/1.86-aarch64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/brendonalexander/.rustup/toolchains/1.86-aarch64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.86.0 (05f9846f8 2025-03-31)";
#[doc=r#"The output of `/Users/brendonalexander/.rustup/toolchains/1.86-aarch64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/brendonalexander/.rustup/toolchains/1.86-aarch64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
