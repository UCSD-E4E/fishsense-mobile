...
extern "C" {
	...
	void cv_imdecodeanimation_const__InputArrayR_AnimationR(const cv::_InputArray* buf, cv::Animation* animation, Result<bool>* ocvrs_return) {
		try {
			bool ret = cv::imdecodeanimation(*buf, *animation);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	
	void cv_imdecodeanimation_const__InputArrayR_AnimationR_int_int(const cv::_InputArray* buf, cv::Animation* animation, int start, int count, Result<bool>* ocvrs_return) {
		try {
			bool ret = cv::imdecodeanimation(*buf, *animation, start, count);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	void cv_imencodeanimation_const_StringR_const_AnimationR_vectorLunsigned_charGR(const char* ext, const cv::Animation* animation, std::vector<unsigned char>* buf, Result<bool>* ocvrs_return) {
		try {
			bool ret = cv::imencodeanimation(std::string(ext), *animation, *buf);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	
	void cv_imencodeanimation_const_StringR_const_AnimationR_vectorLunsigned_charGR_const_vectorLintGR(const char* ext, const cv::Animation* animation, std::vector<unsigned char>* buf, const std::vector<int>* params, Result<bool>* ocvrs_return) {
		try {
			bool ret = cv::imencodeanimation(std::string(ext), *animation, *buf, *params);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
